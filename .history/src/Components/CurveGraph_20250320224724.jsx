...
const GrowthGraph = () => {
  ...
  return (
    <div className="w-full h-64 bg-white relative">
      ...
      <div
        className="absolute inset-0 z-0 bg-gradient-to-t from-green-50 to-green-100 opacity-30"
      />
      <div className="absolute inset-0 z-0 bg-gradient-to-t from-green-50 to-white opacity-30" />
    </div>
  );
};
...
/******  a49cfee5-5f4c-4678-95a4-19ebc37bdcd5  *******/